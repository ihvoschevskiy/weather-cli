...
Для работы приложения нужен токен OpenWeather API (бесплатный план подходит)
...
```
 -d, --daily              Показать погоду на 5 дней
...
Покажет текущую погоду или погоду на следующие 5 дней для города, сохраненного в качестве города по умолчанию
...
Покажет текущую погоду или погоду на следующие 5 дней для указанного города.
